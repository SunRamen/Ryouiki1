...
def human():
    ...
    for i in range(4):
      if person_data1["pose_keypoints_2d"][3*(i+1) + 2] > min:     
    ...
    if person_data1["pose_keypoints_2d"][3*5 + 2] > min:    
    ...
    for i in range(2):
        if person_data1["pose_keypoints_2d"][3*(i+6) + 2] > min:   
    ...
    for i in range(2):
        if person_data1["pose_keypoints_2d"][3*(i+8) + 2] > min:      
    ...
    if person_data1["pose_keypoints_2d"][3*12 + 2] > min:    
    ...
    for i in range(1):
       if person_data1["pose_keypoints_2d"][3*(i+13) + 2] > min:     
    ...
    if person_data1["pose_keypoints_2d"][3*21 + 2] > min:        
    ...
    if person_data1["pose_keypoints_2d"][3*19 + 2] > min:    
        canvas.create_line(person_data1["pose_keypoints_2d"][3*14 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*14 + 1]/2,
                            person_data1["pose_keypoints_2d"][3*19 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*19 + 1]/2)
    if person_data1["pose_keypoints_2d"][3*20 + 2] > min:                  
    ...
    if person_data1["pose_keypoints_2d"][3*15 + 2] > min: 
    ...
    if person_data1["pose_keypoints_2d"][3*16 + 2] > min:   
        canvas.create_line(person_data1["pose_keypoints_2d"][3*0 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*0 + 1]/2,
                            person_data1["pose_keypoints_2d"][3*16 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*16 + 1]/2)
    if person_data1["pose_keypoints_2d"][3*17 + 2] > min:                                   
    ...
    if person_data1["pose_keypoints_2d"][3*8 + 2] > min:    
        canvas.create_line(person_data1["pose_keypoints_2d"][3*1 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*1 + 1]/2,
                            person_data1["pose_keypoints_2d"][3*8 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*8 + 1]/2) 

    if person_data1["pose_keypoints_2d"][3*18 + 2] > min:
    ...
    if person_data1["pose_keypoints_2d"][3*24 + 2] > min:    
    ...
    if person_data1["pose_keypoints_2d"][3*22 + 2] > min:   
        canvas.create_line(person_data1["pose_keypoints_2d"][3*11 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*11 + 1]/2,
                            person_data1["pose_keypoints_2d"][3*22 + 0]/2,
                            person_data1["pose_keypoints_2d"][3*22 + 1]/2)
    if person_data1["pose_keypoints_2d"][3*23 + 2] > min:
    ...
    if person_data2["pose_keypoints_2d"][3*5 + 2] > min:        
    ...
    for i in range(2):
        if person_data2["pose_keypoints_2d"][3*(i+6) + 2] > min:
    ...
    for i in range(2): 
        if person_data2["pose_keypoints_2d"][3*(i+9) + 2] > min:
    ...
    if person_data2["pose_keypoints_2d"][3*12 + 2] > min:
    ...
    for i in range(1):
        if person_data2["pose_keypoints_2d"][3*(i+13) + 2]>min:
    ...
    if person_data2["pose_keypoints_2d"][3*21 + 2] > min:
    ...
    if person_data2["pose_keypoints_2d"][3*19 + 2] > min:
        canvas.create_line(person_data2["pose_keypoints_2d"][3*14 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*14 + 1]/2,
                            person_data2["pose_keypoints_2d"][3*19 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*19 + 1]/2)
    
    if person_data2["pose_keypoints_2d"][3*20 + 2] > min:
    ...
    if person_data2["pose_keypoints_2d"][3*15 + 2]> min:
    ...
    if person_data2["pose_keypoints_2d"][3*16 + 2]> min:                                
        canvas.create_line(person_data2["pose_keypoints_2d"][3*0 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*0 + 1]/2,
                            person_data2["pose_keypoints_2d"][3*16 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*16 + 1]/2)
        
    if person_data2["pose_keypoints_2d"][3*17 + 2]> min:
    ...
    if person_data2["pose_keypoints_2d"][3*8 + 2]>min: 
        canvas.create_line(person_data2["pose_keypoints_2d"][3*1 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*1 + 1]/2,
                            person_data2["pose_keypoints_2d"][3*8 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*8 + 1]/2)
        
    if person_data2["pose_keypoints_2d"][3*18 + 2]>min: 
    ...
    if person_data2["pose_keypoints_2d"][3*24 + 2] >min: 
    ...
    if person_data2["pose_keypoints_2d"][3*22 + 2] > min:
        canvas.create_line(person_data2["pose_keypoints_2d"][3*11 + 0]/2,
                            person_data2["pose_keypoints_2d"][3*11 + 1]/2,
